...
const flowers = [
  { emoji: "🌹", name: "Rose", message: "My love for you is deep and true." },
  { emoji: "🌻", name: "Sunflower", message: "You bring sunshine to my life everyday." },
  { emoji: "🌷", name: "Tulip", message: "Our love is growing more beautiful with time." },
];
